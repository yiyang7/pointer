...
# pre-trained + full tuning
# train
python run_summarization.py --mode=train --data_path=../processed_10_1k/processed_combine2/finished_combine2_story/chunked/train* --vocab_path=../finished_cnn_files/vocab --log_root=log --exp_name=pretrained_full_tune_combine2_exp --train_size=19050
# convert
...
# decode
python run_summarization.py --mode=decode --data_path=../processed_10_1k/processed_combine2/finished_combine2_story/chunked/test* --vocab_path=../finished_cnn_files/vocab --log_root=log --exp_name=pretrained_full_tune_rcombine2_exp --max_enc_steps=400 --max_dec_steps=120 --coverage=1 --single_pass=1
...
# --- combine2 + pgen
# train
python run_summarization.py --mode=train --data_path=../processed_10_1k/processed_combine2/finished_combine2_story/chunked/train* --vocab_path=../finished_cnn_files/vocab --log_root=log --exp_name=load_word_emb_multi_attn_combine2_exp --use_multi_attn=True --subred_size=2 --train_size=9525
# convert
python run_summarization.py --mode=train --data_path=../processed_10_1k/processed_combine2/finished_combine2_story/chunked/train* --vocab_path=../finished_cnn_files/vocab --log_root=log --exp_name=load_word_emb_multi_attn_combine2_exp --use_multi_attn=True --subred_size=2 --train_size=9525 --coverage=1 --convert_to_coverage_model=1
# decode
