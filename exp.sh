...
# pre-trained
# convert
python run_summarization.py --mode=train --data_path=../processed_10_1k/processed_combine_all/finished_combine_all_story/chunked/train* --vocab_path=../finished_cnn_files/vocab --log_root=log --exp_name=pretrained_combine_exp --fine_tune=False --train_size=93390 --coverage=1 --convert_to_coverage_model=1
# decode
python run_summarization.py --mode=decode --data_path=../processed_10_1k/processed_combine_all/finished_combine_all_story/chunked/test* --vocab_path=../finished_cnn_files/vocab --log_root=log --exp_name=pretrained_combine_exp --train_size=93390 --max_enc_steps=400 --max_dec_steps=120 --coverage=1 --single_pass=1

# pre-trained + full tuning
# train
python run_summarization.py --mode=train --data_path=../processed_10_1k/processed_combine_all/finished_combine_all_story/chunked/train* --vocab_path=../finished_cnn_files/vocab --log_root=log --exp_name=pretrained_full_tune_combine_exp --fine_tune=False --train_size=93390
# convert
python run_summarization.py --mode=train --data_path=../processed_10_1k/processed_combine_all/finished_combine_all_story/chunked/train* --vocab_path=../finished_cnn_files/vocab --log_root=log --exp_name=pretrained_full_tune_combine_exp --fine_tune=False --train_size=93390 --coverage=1 --convert_to_coverage_model=1
# decode
python run_summarization.py --mode=decode --data_path=../processed_10_1k/processed_combine_all/finished_combine_all_story/chunked/test* --vocab_path=../finished_cnn_files/vocab --log_root=log --exp_name=pretrained_full_tune_rcombine_exp --train_size=93390 --max_enc_steps=400 --max_dec_steps=120 --coverage=1 --single_pass=1
...
# ------------ Exp 2 ------------
# train
python run_summarization.py --mode=train --data_path=../processed_10_1k/processed_combine_all/finished_combine_all_story/chunked/train* --vocab_path=../finished_cnn_files/vocab --log_root=log --exp_name=load_word_emb_multi_attn_combine_exp --use_multi_attn=True --subred_size=3 --train_size=93460
# convert
python run_summarization.py --mode=train --data_path=../processed_10_1k/processed_combine_all/finished_combine_all_story/chunked/train* --vocab_path=../finished_cnn_files/vocab --log_root=log --exp_name=load_word_emb_multi_attn_combine_exp --use_multi_attn=True --subred_size=3 --train_size=93460 --coverage=1 --convert_to_coverage_model=1
# decode
python run_summarization.py --mode=decode --data_path=../processed_10_1k/processed_combine_all/finished_combine_all_story/chunked/test* --vocab_path=../finished_cnn_files/vocab --log_root=log --exp_name=load_word_emb_multi_attn_combine_exp --use_multi_attn=True --subred_size=3 --train_size=93460 --max_enc_steps=400 --max_dec_steps=120 --coverage=1 --single_pass=1
